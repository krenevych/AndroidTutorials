...
Під час розробки часто буває потрібно перевірити, що відбувається всередині програми (які значення приймають змінні, чи викликається певний код). Для цього в Android використовується клас `Log`.
