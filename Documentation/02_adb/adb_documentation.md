...
* Відобразити список усіх активних процесів у системі:
  ...
  adb shell ps
  ```
  _Деякі корисні параметри утиліти `ps`:_
  ...
  * `-o PID,NAME` — форматує вивід, залишаючи лише дві вказані колонки (ідентифікатор процесу та його назву). Це зручно для подальшої фільтрації списку.
  
  _Приклад (сформувати чистий список із двох колонок і відфільтрувати за словом):_
  ```bash
